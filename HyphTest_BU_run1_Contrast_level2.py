...
SECOND_LEVEL_DIR = os.path.join(IMG_DIR, "contrast/BU_run1_level2")
if os.path.exists(SECOND_LEVEL_DIR):
    shutil.rmtree(SECOND_LEVEL_DIR)
os.makedirs(SECOND_LEVEL_DIR, exist_ok=True)

SECOND_LEVEL_CONTRASTS = [
    "feedback_desirable",
    "feedback_undesirable",
    "confi",
    "feedback_desirable-undesirable",
]
