...
SECOND_LEVEL_DIR = os.path.join(IMG_DIR, "contrast/DOT_level2")
os.makedirs(SECOND_LEVEL_DIR, exist_ok=True)

SECOND_LEVEL_CONTRASTS = [
    "resp_correct-incorrect",
    "confi_correct_rating",
    "confi_incorrect_rating",
    "rating_correct-incorrect"
]


def load_first_level_maps(contrast_name: str, group_map: dict[str, str]) -> pd.DataFrame:
    """
    Scan FIRST_LEVEL_DIR for c-maps of *contrast_name*.
